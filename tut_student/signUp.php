...
<body>
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                <div class="bodyTop">
                    <h3 class="text-center text-muted">Create Student Account.</h3>

                </div>
            </div>
        </div>
        <form action="signUp.php" method="POST" enctype="multipart/form-data" class="accForm">
            <div class="form-row">
...
$sql_email="select * from  tut_student where stu_email='$email' or stu_number='$stud_num';";
...
else
{
     ...
     $sql="INSERT INTO tut_student(stu_name,stu_surname,stu_number,stu_email,stu_gender,
            stu_campus,stu_faculty,stu_password)
       VALUES ('$name','$surname','$stud_num','$email','$gender','$campus',' $faculty','$password');";
       $run_query= mysqli_query($conn,$sql);
        echo "<script>alert('Student $name successfully registered;) ');</script>";
