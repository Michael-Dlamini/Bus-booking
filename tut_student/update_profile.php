...
<body>
    <div class="container">
        ...
        <form action="update_profile.php" method="POST" enctype="multipart/form-data" class="accForm">
            ...
            <div class="form-row">
                ...
                <input type="text" name="gender" class="form-control" placeholder="Email"
              value="<?php echo  $stu_gender ?>"   required>
                </div>
            </div>
 ...
 <input id="confirmPassword" type="password" name="password" class="form-control" placeholder="Confirm Password" required>
           ...
           <input  name="submit_update_acc" class="btn btn-success" type="submit" value="Update"/>
      ...
      if(!preg_match("/^[a-zA-Z\s]+$/",$name))
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL))
         ...
         if($password == $confirmPassword)
         {
             ...
             $sql="UPDATE tut_student
        SET stu_name='$name',stu_surname='$surname',stu_number='$stud_num',stu_email='$email',
        stu_gender='$gender',stu_campus='$campus',stu_faculty='$faculty',stu_password='$password'
        WHERE stu_id='$id';";
